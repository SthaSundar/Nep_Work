    ...
    return (
        <div className="min-h-screen bg-white py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Stats */}
                <div className="bg-blue-50 rounded-lg shadow-sm p-8 mb-16 border border-blue-200">
                    <h2 className="text-3xl font-bold text-center text-blue-800 mb-8">
                        Platform Statistics
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
                        ...
                        <div>
                            ...
                            <div className="text-blue-700">Services Offered</div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="text-blue-700">Satisfaction Rate</div>
                        </div>
                    </div>
                </div>
